...
class FenixNaviApp extends Application.AppBase {
    ...
    function initialize() {
        ...
        _demoScenarios = [
            ...
            ["roundabout", "Roundabout, take exit 1 onto Via Alba", "Via Alba", 60, 0, false, 1, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 2 onto Via Bra", "Via Bra", 60, 45, false, 2, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 3 onto Via Cuneo", "Via Cuneo", 60, 90, false, 3, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 4 onto Via Dronero", "Via Dronero", 60, 135, false, 4, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 2 onto Via Barge", "Via Barge", 60, -45, false, 2, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 3 onto Via Cavour", "Via Cavour", 60, -90, false, 3, 4, 8, 4, 0.8],
            ["roundabout", "Roundabout, take exit 4 onto Via Dogliani", "Via Dogliani", 60, -135, false, 4, 4, 8, 4, 0.8],
